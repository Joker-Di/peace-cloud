...
CREATE TABLE `cms_file` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=153 DEFAULT CHARSET=utf8 COMMENT='文件上传';

-- ----------------------------
-- Records of cms_file
-- ----------------------------
INSERT INTO `cms_file` VALUES ('147', '1', 'http://localhost:8004/files/32/16/e31c21e6-50cc-4509-8eea-13b1fcbaebc8', '2018-08-28 17:48:44');
INSERT INTO `cms_file` VALUES ('148', '1', 'http://localhost:8004/files/13/98/cf98c3ea-5435-4788-85d9-2e5c1ad8d539', '2018-08-28 17:49:55');
INSERT INTO `cms_file` VALUES ('149', '1', 'http://localhost:8004/files/93/18/566723ef-f1b0-4044-a696-c2f3fed669f0', '2018-08-28 17:50:02');
INSERT INTO `cms_file` VALUES ('150', '1', 'http://localhost:8004/files/42/12/638f3c1f-a3a5-4da5-9c80-4fae6c636382', '2018-08-28 17:50:18');
INSERT INTO `cms_file` VALUES ('151', '1', 'http://localhost:8004/files/4/88/cb0b4662-a338-4a7c-a115-b10e36758d9f', '2018-08-28 17:50:23');
INSERT INTO `cms_file` VALUES ('152', '1', 'http://localhost:8004/files/10/67/da29ca7e-c747-42e3-89f3-bdf7446cd11f', '2018-08-29 14:49:26');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
INSERT INTO `sys_log` VALUES ('84', '1', 'admin', '获取用户列表', '30', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-28 16:50:03');
INSERT INTO `sys_log` VALUES ('85', '1', 'admin', '获取用户列表', '47', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-28 17:47:10');
INSERT INTO `sys_log` VALUES ('86', '1', 'admin', '获取用户列表', '10', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-28 17:56:08');
INSERT INTO `sys_log` VALUES ('87', '1', 'admin', '获取用户列表', '21', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-28 17:56:55');
INSERT INTO `sys_log` VALUES ('88', '1', 'admin', '获取用户列表', '10', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-28 18:33:30');
INSERT INTO `sys_log` VALUES ('89', '1', 'admin', '获取用户列表', '9', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-28 18:33:33');
INSERT INTO `sys_log` VALUES ('90', '1', 'admin', '获取用户列表', '11', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-28 18:33:53');
INSERT INTO `sys_log` VALUES ('91', '1', 'admin', '获取用户列表', '11', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-28 18:33:55');
INSERT INTO `sys_log` VALUES ('95', '0', '', '登录', '19', 'com.bootdo.clouddoadmin.controller.LoginController.login()', null, '127.0.0.1', '2018-08-29 14:47:47');
INSERT INTO `sys_log` VALUES ('96', '0', '', '登录', '16', 'com.bootdo.clouddoadmin.controller.LoginController.login()', null, '127.0.0.1', '2018-08-29 14:48:42');
INSERT INTO `sys_log` VALUES ('97', '1', 'admin', '获取用户列表', '542', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-29 14:49:54');
INSERT INTO `sys_log` VALUES ('98', '1', 'admin', '获取用户列表', '8', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-29 14:50:00');
INSERT INTO `sys_log` VALUES ('99', '1', 'admin', '获取用户列表', '3007', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-29 14:52:06');
INSERT INTO `sys_log` VALUES ('100', '1', 'admin', '获取用户列表', '1822', 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', null, '127.0.0.1', '2018-08-29 14:52:14');
